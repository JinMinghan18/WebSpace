...
<%
    ...
    ArrayList<newpaper> newpaperArrayList = dao.allnewpaper();
...
<%@ page import="com.model.newpaper" %>
        ...
        <div class="container-fluid" style="padding-bottom: 66px;">
            <div class="server bgw mtb15">
                <div class="title c6 f16 plr15">
                    <h3 class="c6 f16 pull-left">newpaper</h3>
                </div>
                <div class="server-circle">
                    <table id="firewallBody" class="table table-hover" style="min-width: 640px;border: 0 none;">
                        <thead>
                        <tr>
                            <th style="width: 15%">paper_name</th>
                            <th style="width: 15%">paper_time</th>
                            <th>pape_category</th>
                            <th>paper_introduce</th>
                        </tr>
                        </thead>
                        <tbody>
                        <c:forEach var="i_item" items="${requestScope.newpaperArrayList}" varStatus="status">
                            ...
                            <td>${i_item.paper_name}</td>
                            <td>${i_item.paper_time}</td>
                            <td>${i_item.paper_category}</td>
                            <td>${i_item.paper_introduce}</td>
                            </tr>
                        </c:forEach>
                        </tbody>
                    </table>
