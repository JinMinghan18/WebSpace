...
<body>
    <form action="../CheckformServlet" method="post" name="form" onsubmit="return check_form()" style="margin: 0px auto;background-color: #f2f2f2;width: 373px;height: 1300px">
        <div>
            <img src="../images/HZ_Health_Code.png" />
        </div>
        <h4 align="center">健康码申请</h4>
        <div style="background-color: white">
            <table  style="background-color: white">
                <tr>
                    <td>姓名:</td><td><input type="text" name="name" placeholder="请输入姓名" style="width: 200px"></td>
                </tr>
                <tr>
                    <td>身份证号:</td><td><input type="text" name="id" placeholder="请输入身份证号" style="width: 200px"></td>
                </tr>
                <tr>
                    <td>请输入学号(工号):</td><td><input type="text" name="stuId" placeholder="请输入学号(工号)" style="width: 200px"></td>
                </tr>
                <tr>
                    <td>请输入手机号:</td><td><input type="tel" name="tel" placeholder="请输入手机号" style="width: 200px"></td>
                </tr>
            </table>
        </div><br>
        ...
        <div style="background-color: white">
            ...
            <img src="../images/single_select.jpg"  style="width: 30px;height: 15px;">
            <table>
                <tr>
        ...
        <div style="background-color: white">
            ...
            &nbsp;<img src="../images/multi_select.jpg" style="width: 30px;height: 15px;">
