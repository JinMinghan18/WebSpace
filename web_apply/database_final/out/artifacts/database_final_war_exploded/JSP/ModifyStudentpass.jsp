...
<div class="modifystu">
    <div class="account">
        ...
        <form action="<%=path%>/modifyStudentServlet" method="post">
            ...
            <div class="line" style="display: none">
                <input class="inputtxt" value="<%=request.getParameter("bno").trim()%>" name="bno" id="bno" placeholder="班级" type="text">
            </div>
            <div class="line" style="display: none">
            ...
            <div class="line" style="display: none">
                <input class="inputtxt" value="<%=request.getParameter("shome").trim()%>" name="shome" id="shome" placeholder="生源地" type="text">
            </div>
            <div class="line" style="display: none">
                <input class="inputtxt" value="<%=request.getParameter("spoint").trim()%>" name="spoint" id="spoint" placeholder="学分" type="number">
            </div>
            <div class="line" >
                <input class="inputtxt" value="<%=request.getParameter("spass").trim()%>" name="spass" id="spass" placeholder="密码" type="text">
            </div>
            <div class="login_btn">
